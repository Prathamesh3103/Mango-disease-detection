...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            const Text('Feedback Page', style: TextStyle(color: Colors.white)),
        backgroundColor:
            const Color.fromARGB(255, 7, 107, 35), // Greenery color palette
      ),
      body: Padding(
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusColor: const Color.fromARGB(255, 7, 107, 35),
